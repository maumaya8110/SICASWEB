...
namespace CASCO.DAO
{
    ...
    {
        public static string connStr = Utils.CadenaConexionSICAS;
        ...
        public static void DoTransactions(HelperDelegate method)
        {
            try
            {
                DB.BeginTransaction();
        ...
        public static object ExecuteCommandSP_With_Return(string execQuery, Hashtable m_params)
        {
            ...
            {
                throw new Exception("ExecuteCommandSP_With_Return", ex);
            }
            finally
            {
                if (!IsTransaction)
