...
gj.grid.methods = {
    ...
    getSelections: function ($grid) {
        ...
        if (0 < $selections.length) {
            $selections.each(function () {
                ...
                record = $grid.get(position);
                var rowret = gj.grid.methods.getId(record, $grid.data().primaryKey, position);
                result.push(rowret);
            });
        }
        return result;
    ...
    getByPosition: function ($grid, position) {
        var arrAux = $grid.getAll(false);
        return arrAux[position - 1];
    },
...
gj.grid.widget = function ($grid, arguments) {
    ...
    self.getSelectedRows = function () {
        return methods.getSelectedRows(this);
    };
    ...
    base: {
        ...
        inlineEditing: {
            ...
            */
            ...
            managementColumnConfig: { align: 'center', renderer: gj.grid.plugins.inlineEditing.renderers.editManager }
        }
    },
